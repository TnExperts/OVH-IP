...
$curContent = $curContent.'<table border=0 width=100%><tr><td width=100% align=center>OVH IP Subnet availability of all sizes and all countries<br>&nbsp;<br><table border=1>';
